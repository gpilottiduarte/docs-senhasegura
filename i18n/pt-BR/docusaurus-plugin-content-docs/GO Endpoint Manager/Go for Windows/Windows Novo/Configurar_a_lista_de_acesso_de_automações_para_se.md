...
10. Marque as opções para a **Configuração de elevação.**
	...
	* **Aprovação em níveis.**Para funcionar, os aprovadores devem estar cadastrados em níveis no [Relatório de aprovadores](https:/{/* docs */}.senhasegura.io{/* v */}3-32{/* docs */}{/* pt */}{/* pam */}-session-approvers-tab).
