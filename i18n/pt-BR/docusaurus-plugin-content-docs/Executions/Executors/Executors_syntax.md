...
Alguns dos comandos do [linux x3270](http:/{/* x */}3270.bgp.nu/) foram substituidos por aliases do executor para tornar a integração com o senhasegura fácil e segura.
