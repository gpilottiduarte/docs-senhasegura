...
|----|----|----|----|----|----|
| `identifier`| String  |Sim. Esse valor é obtido na resposta da requisição GET Listar todas as credenciais.  |    String única definida pelo usuário ou pelo senhasegura para identificar a credencial. | 123| -
